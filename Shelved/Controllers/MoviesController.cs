...
namespace Shelved.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Title,ApplicationUserId,Year,Seen,ImagePath")] Movie movie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Title,ApplicationUserId,Year,Seen,ImagePath")] Movie movie)
        {
            if (id != movie.Id)
            {
                return NotFound();
